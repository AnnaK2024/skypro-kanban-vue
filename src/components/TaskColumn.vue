        ...
        <div v-else>
          <div class="main__block">
            <div v-for="status in statuses" :key="status">
              <div class="main__content" v-for="card in filteredTasks(status)" :key="card.id">
